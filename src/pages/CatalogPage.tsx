          ...
          <div style={{ marginBottom: 24 }}>
            ...
            {([
              ...
              <button key={label} onClick={() => setGame(value)} style={{
                ...
                backgroundColor: activeGame === value ? '#F5F5F5' : 'transparent',
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            {([
              ...
              <button key={value} onClick={() => setCategory(value)} style={{
                ...
                fontSize: 13, border: 'none', cursor: 'pointer',
                backgroundColor: activeCategory === value ? '#F5F5F5' : 'transparent',
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <button
                ...
                style={{
                  ...
                  padding: '7px 10px', borderRadius: 'var(--radius-full)',
                  fontSize: 13, border: 'none', cursor: 'pointer',
                  backgroundColor: activeSet === null ? '#F5F5F5' : 'transparent',
              ...
              {availableSets.map(([code, name]) => (
                <button
                  ...
                  style={{
                    ...
                    padding: '7px 10px', borderRadius: 'var(--radius-full)',
                    fontSize: 13, border: 'none', cursor: 'pointer',
                    backgroundColor: activeSet === code ? '#F5F5F5' : 'transparent',
