...
export default function NotFoundPage() {
  return (
    <div style={{ maxWidth: 480, margin: '100px auto', padding: '0 13px', textAlign: 'center' }}>
      ...
      <Link to="/" style={{ padding: '10px 24px', backgroundColor: 'var(--brand-blue)', color: '#fff', borderRadius: 'var(--radius-md)', fontSize: 14, fontWeight: 500 }}>
        Go home
      </Link>
    </div>
  )
